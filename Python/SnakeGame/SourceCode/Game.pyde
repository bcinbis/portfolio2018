...
import Mover, Scroll, Fruit, PastVals, Scores, Timer, BlocksorsWowsers

F1 = Fruit.Fruits( False, random(0, 2000), random(0, 1000))

def setup():
    size(int(2000 / 20) * 20, (int(2000 / 20) * 20) - 40)
    frameRate(100)
